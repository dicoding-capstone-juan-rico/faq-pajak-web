...
import { ArrowRight, Mail, Lock, ShieldCheck, ArrowLeft, LayoutDashboard } from 'lucide-react';
...
const AdminLoginPage = () => {
    ...
    const handleAdminLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(err.message || 'Akses ditolak. Pastikan Anda memiliki hak akses Admin.'); 
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-white dark:bg-[#022c22]">
            {/* Abstract Background Elements (Identik dengan User) */}
            ...
            <div className="max-w-7xl w-full mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center py-20">
                ...
                >
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-white/10 border border-gray-200 dark:border-white/10 mb-8 shadow-sm">
                        <ShieldCheck size={14} className="text-[#022c22] dark:text-[#cdfc4d]" />
                    ...
                    <h1 className="text-5xl font-bold text-[#022c22] dark:text-white leading-[1.1] tracking-tight mb-6">
                        ...
                        <span className="relative inline-block">
                            <span className="relative z-10 text-[#022c22] dark:text-white italic">efisien.</span>
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300 max-w-md leading-relaxed">
                        Masuk sebagai admin untuk memantau aktivitas pengguna, mengelola data pajak, dan mengatur konfigurasi sistem.
                    </p>
                </motion.div>

                {/* Right Column: Admin Login Form Card */}
                <motion.div
                ...
                >
                    <div className="bg-white dark:bg-[#0a3528] rounded-[2.5rem] p-8 sm:p-10 shadow-2xl border border-gray-100 dark:border-white/5 relative z-20">
                        ...
                        <div className="block lg:hidden mb-8 text-center">
                            <LayoutDashboard className="mx-auto mb-4 text-[#022c22] dark:text-[#cdfc4d]" size={32} />
                            <h2 className="text-3xl font-bold text-[#022c22] dark:text-white mb-2">Admin Login</h2>
                            <p className="text-sm text-gray-600 dark:text-gray-400">Masuk ke dashboard manajemen</p>
                        </div>
                        ...
                        <div className="mt-8 pt-6 border-t border-gray-100 dark:border-white/10 text-center">
                            <p className="text-xs text-gray-500 dark:text-gray-400 italic font-medium">
                                Area Terbatas: Akses hanya untuk staf berwenang.
                            </p>
                        </div>
                    </div>
                </motion.div>
